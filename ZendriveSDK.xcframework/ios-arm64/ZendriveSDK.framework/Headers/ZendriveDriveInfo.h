...
@class ZendriveExtrapolationDetails;
@class ZendriveVehicleTaggingDetails;
/**
 * ZendriveDriveInfo
 *
 ...
 * If `driveType` is not `ZendriveDriveType.ZendriveDriveTypeDrive` then it will be set to nil.
 */
