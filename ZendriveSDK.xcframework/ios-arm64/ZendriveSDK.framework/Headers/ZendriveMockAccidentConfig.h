...
/**
 * This field specifies the [vehicle type][vehicleTypeId] at the time of [potential accident callback][potentialId] and [final accident callback][finalId].
 *
 * Default value is `ZendriveVehicleType.ZendriveVehicleTypeCar`.
 *
 * [vehicleTypeId]: ../Enums/ZendriveVehicleType.html
 * [potentialId]: ../Protocols/ZendriveDelegateProtocol.html#/c:objc(pl)ZendriveDelegateProtocol(im)processPotentialAccidentDetected:
 * [finalId]: ../Protocols/ZendriveDelegateProtocol.html#/c:objc(pl)ZendriveDelegateProtocol(im)processAccidentDetected:
*/
@property (nonatomic, assign) ZendriveVehicleType vehicleType;
 ...
 *
 * Default value is `ZendriveCollisionSeverity.ZendriveCollisionSeverityHigh`.
 *
 * [collisionSeverityId]: ../Enums/ZendriveCollisionSeverity.html
 * [potentialId]: ../Protocols/ZendriveDelegateProtocol.html#/c:objc(pl)ZendriveDelegateProtocol(im)processPotentialAccidentDetected:
 * [finalId]: ../Protocols/ZendriveDelegateProtocol.html#/c:objc(pl)ZendriveDelegateProtocol(im)processAccidentDetected:
*/
@property (nonatomic, assign) ZendriveCollisionSeverity collisionSeverity;
 ...
 *
 * Default value is `ZendriveDirectionOfImpact.ZendriveDirectionOfImpactUnknown`.
 *
 * [directionOfImpactId]: ../Enums/ZendriveDirectionOfImpact.html
 * [potentialId]: ../Protocols/ZendriveDelegateProtocol.html#/c:objc(pl)ZendriveDelegateProtocol(im)processPotentialAccidentDetected:
 * [finalId]: ../Protocols/ZendriveDelegateProtocol.html#/c:objc(pl)ZendriveDelegateProtocol(im)processAccidentDetected:
*/
@property (nonatomic, assign) ZendriveDirectionOfImpact directionOfImpact;
