 ...
 */
typedef NS_ENUM(int, ZendriveCollisionSeverity) {
    /**
     * Indicates an unknown collision severity.
     */
    ZendriveCollisionSeverityUnknown = 0,

    /**
     * Indicates a low collision severity.
     */
    ZendriveCollisionSeverityLow = 1,

    /**
     * Indicates a high collision severity.
     */
    ZendriveCollisionSeverityHigh = 2
};

/**
 * Direction of Impact of the detected accident.
 */
typedef NS_ENUM(int, ZendriveDirectionOfImpact) {
    /**
     * Indicates an unknown direction of impact.
     */
    ZendriveDirectionOfImpactUnknown = 0,

    /**
     * Indicates a front direction of impact.
     */
    ZendriveDirectionOfImpactFront = 1,

    /**
     * Indicates a rear direction of impact.
     */
    ZendriveDirectionOfImpactRear = 2,

    /**
     * Indicates a broadside direction of impact.
     */
    ZendriveDirectionOfImpactBroadside = 3
};
 ...
 * `ZendriveVehicleType.ZendriveVehicleTypeCar` is the default value.
 */
 ...
 * `ZendriveCollisionSeverity.ZendriveCollisionSeverityUnknown` is the default value.
 */
 ...
 * `ZendriveDirectionOfImpact.ZendriveDirectionOfImpactUnknown` is the default value.
 */
