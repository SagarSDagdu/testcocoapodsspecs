...
/**
 * Information of the drive to be simulated. This information will be used in the [ZendriveDriveInfo](https://zendrive-root.bitbucket.io/ios/docs/sdk-9.1.0-a1/Classes/ZendriveDriveInfo.html) and [AccidentInfo](https://zendrive-root.bitbucket.io/ios/docs/sdk-9.1.0-a1/Classes/ZendriveAccidentInfo.html) objects returned by the ZendriveSDK callbacks via [ZendriveDelegateProtocol](https://zendrive-root.bitbucket.io/ios/docs/sdk-9.1.0-a1/Protocols/ZendriveDelegateProtocol.html).
 *
...
/**
 * The type of the drive. This decides what other info parameters will be populated. See [here](https://zendrive-root.bitbucket.io/ios/docs/sdk-9.1.0-a1/Enums/ZendriveDriveType.html).
 *
...
/**
 * Whether the user was a driver or a passenger. See [here](https://zendrive-root.bitbucket.io/ios/docs/sdk-9.1.0-a1/Enums/ZendriveUserMode.html).
 */
@property (nonatomic, assign, readonly) ZendriveUserMode userMode;

/**
 * The [start timestamp](https://zendrive-root.bitbucket.io/ios/docs/sdk-9.1.0-a1/Classes/ZendriveDriveInfo.html#/c:objc(cs)ZendriveDriveInfo(py)startTimestamp) of trip in milliseconds since epoch.
 */
@property (nonatomic, assign, readonly) long long startTimestamp;

/**
 * The [end timestamp](https://zendrive-root.bitbucket.io/ios/docs/sdk-9.1.0-a1/Classes/ZendriveDriveInfo.html#/c:objc(cs)ZendriveDriveInfo(py)endTimestamp) of trip in milliseconds since epoch.
 */
@property (nonatomic, assign, readonly) long long endTimestamp;

/**
 * The [average speed](https://zendrive-root.bitbucket.io/ios/docs/sdk-9.1.0-a1/Classes/ZendriveDriveInfo.html#/c:objc(cs)ZendriveDriveInfo(py)averageSpeed) of trip in metres/second.
 */
@property (nonatomic, assign, readonly) double averageSpeed;

/**
 *  The [vehicleTaggingDetails](https://zendrive-root.bitbucket.io/ios/docs/sdk-9.1.0-a1/Classes/ZendriveVehicleTaggingDetails.html)
 */
@property (nonatomic, strong, nullable, readonly) ZendriveVehicleTaggingDetails *vehicleTaggingDetails;

/**
 * The [maximum speed](https://zendrive-root.bitbucket.io/ios/docs/sdk-9.1.0-a1/Classes/ZendriveDriveInfo.html#/c:objc(cs)ZendriveDriveInfo(py)maxSpeed) of trip in metres/second.
 */
@property (nonatomic, assign, readonly) double maxSpeed;

/**
 * The [distance](https://zendrive-root.bitbucket.io/ios/docs/sdk-9.1.0-a1/Classes/ZendriveDriveInfo.html#/c:objc(cs)ZendriveDriveInfo(py)distance) of the trip in metres.
 */
@property (nonatomic, assign, readonly) double distance;

/**
 * The [vehicleType](https://zendrive-root.bitbucket.io/ios/docs/sdk-9.1.0-a1/Classes/ZendriveDriveInfo.html#/c:objc(cs)ZendriveDriveInfo(py)vehicleType) of the trip.
 */
@property (nonatomic, readonly) ZendriveVehicleType vehicleType;

/**
 * A list of [ZendriveLocationPoint](https://zendrive-root.bitbucket.io/ios/docs/sdk-9.1.0-a1/Classes/ZendriveLocationPoint.html) objects corresponding to this trip in
...
/**
 * List of [ZendriveEvent](https://zendrive-root.bitbucket.io/ios/docs/sdk-9.1.0-a1/Classes/ZendriveEvent.h) objects.
...
/**
 * The event ratings for this trip. See [here](https://zendrive-root.bitbucket.io/ios/docs/sdk-9.1.0-a1/Classes/ZendriveEventRatings.html)
 */
...
/**
 * The driving behaviour score for this trip. See [here](https://zendrive-root.bitbucket.io/ios/docs/sdk-9.1.0-a1/Classes/ZendriveDriveScore.html)
 */
@property (nonatomic, strong, nonnull, readonly) ZendriveDriveScore *score;

/**
 * The position of the phone during this trip. See [this](https://zendrive-root.bitbucket.io/ios/docs/sdk-9.1.0-a1/Enums/ZendrivePhonePosition.html).
 */
 ...
 * - SDK must be setup. See [[Zendrive setupWithConfiguration:delegate:completionHandler:]](https://zendrive-root.bitbucket.io/ios/docs/sdk-9.1.0-a1/Classes/Zendrive.html#/c:objc(cs)Zendrive(cm)setupWithConfiguration:delegate:completionHandler:)
 * - [AutoDetection mode](https://zendrive-root.bitbucket.io/ios/docs/sdk-9.1.0-a1/Classes/Zendrive.html#/c:objc(cs)Zendrive(cm)setDriveDetectionMode:) must be ON.
