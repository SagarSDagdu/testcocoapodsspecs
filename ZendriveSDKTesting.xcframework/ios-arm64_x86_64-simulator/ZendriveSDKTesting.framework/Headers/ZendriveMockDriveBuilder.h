...
typedef NS_ENUM(int, ZendrivePresetTripType) {
     ...
     * <b>Events</b>: [Hard brake](https://zendrive-root.bitbucket.io/ios/docs/sdk-9.1.0-a1/Enums/ZendriveEventType.html#/c:@E@ZendriveEventType@ZendriveEventHardBrake) and [Aggressive Acceleration](https://zendrive-root.bitbucket.io/ios/docs/sdk-9.1.0-a1/Enums/ZendriveEventType.html#/c:@E@ZendriveEventType@ZendriveEventAggressiveAcceleration)
     */
    Urban10MinTrip = 0,
     ...
     * <b>Events</b>: [Hard brake](https://zendrive-root.bitbucket.io/ios/docs/sdk-9.1.0-a1/Enums/ZendriveEventType.html#/c:@E@ZendriveEventType@ZendriveEventHardBrake), [overspeeding](https://zendrive-root.bitbucket.io/ios/docs/sdk-9.1.0-a1/Enums/ZendriveEventType.html#/c:@E@ZendriveEventType@ZendriveEventOverSpeeding) and [phone handling](https://zendrive-root.bitbucket.io/ios/docs/sdk-9.1.0-a1/Enums/ZendriveEventType.html#/c:@E@ZendriveEventType@ZendriveEventPhoneHandling)
     */
    Highway60MinTrip = 1,
    /**
     ...
     * <b>Events</b>: [Hard brake](https://zendrive-root.bitbucket.io/ios/docs/sdk-9.1.0-a1/Enums/ZendriveEventType.html#/c:@E@ZendriveEventType@ZendriveEventHardBrake), [accident/collision](https://zendrive-root.bitbucket.io/ios/docs/sdk-9.1.0-a1/Enums/ZendriveEventType.html#/c:@E@ZendriveEventType@ZendriveEventAccident) and [hard turn](https://zendrive-root.bitbucket.io/ios/docs/sdk-9.1.0-a1/Enums/ZendriveEventType.html#/c:@E@ZendriveEventType@ZendriveEventHardTurn)
     */
    ...
    */
    ...
    /**
     * A `ZendrivePresetTripType` for [non-driving trip](https://zendrive-root.bitbucket.io/ios/docs/sdk-9.1.0-a1/Enums/ZendriveDriveType.html#/c:@E@ZendriveDriveType@ZendriveDriveTypeNonDriving)<br>
     * <b>Distance</b>: 74990 meters<br>
     * <b>Duration</b>: 66 minutes<br>
     */
    NonDriving60MinTrip = 4,
    /**
     * A `ZendrivePresetTripType` for an [invalid trip](https://zendrive-root.bitbucket.io/ios/docs/sdk-9.1.0-a1/Enums/ZendriveDriveType.html#/c:@E@ZendriveDriveType@ZendriveDriveTypeInvalid)<br>
...
@class ZendriveMockDrive, ZendriveMockEventBuilder, ZendriveVehicleTaggingDetails;
/**
 ...
 *
 *  @see (https://zendrive-root.bitbucket.io/ios/docs/sdk-9.1.0-a1/Classes/ZendriveVehicleTaggingDetails.html)
 */
- (ZendriveMockDriveBuilder *)setVehicleTaggingDetails:(ZendriveVehicleTaggingDetails* _Nullable)vehicleTaggingDetails;
...
/**
 * Set the [drive type](https://zendrive-root.bitbucket.io/ios/docs/sdk-9.1.0-a1/Enums/ZendriveDriveType.html).
 * Default value is [ZendriveDriveTypeInvalid](https://zendrive-root.bitbucket.io/ios/docs/sdk-9.1.0-a1/Enums/ZendriveDriveType.html#/c:@E@ZendriveDriveType@ZendriveDriveTypeInvalid).
 */
- (ZendriveMockDriveBuilder *)setDriveType:(ZendriveDriveType)driveType;

/**
 * Set the [vehicleType](https://zendrive-root.bitbucket.io/ios/docs/sdk-9.1.0-a1/Enums/ZendriveVehicleType.html).
 *
 * For trip with drive type as [ZendriveDriveTypeDrive](https://zendrive-root.bitbucket.io/ios/docs/sdk-9.1.0-a1/Enums/ZendriveDriveType.html#/c:@E@ZendriveDriveType@ZendriveDriveTypeDrive), the default value is [ZendriveVehicleTypeCar](https://zendrive-root.bitbucket.io/ios/docs/sdk-9.1.0-a1/Enums/ZendriveVehicleType.html#/c:@E@ZendriveVehicleType@ZendriveVehicleTypeCar).
 * For trip with drive type as [ZendriveDriveTypeNonDriving](https://zendrive-root.bitbucket.io/ios/docs/sdk-9.1.0-a1/Enums/ZendriveDriveType.html#/c:@E@ZendriveDriveType@ZendriveDriveTypeNonDriving) or [ZendriveDriveTypeInvalid](https://zendrive-root.bitbucket.io/ios/docs/sdk-9.1.0-a1/Enums/ZendriveDriveType.html#/c:@E@ZendriveDriveType@ZendriveDriveTypeInvalid), vehicleType will be defaulted to [ZendriveVehicleTypeUnknown](https://zendrive-root.bitbucket.io/ios/docs/sdk-9.1.0-a1/Enums/ZendriveVehicleType.html#/c:@E@ZendriveVehicleType@ZendriveVehicleTypeUnknown).
 *
 * @note if [ZendriveVehicleTypeUnknown](https://zendrive-root.bitbucket.io/ios/docs/sdk-9.1.0-a1/Enums/ZendriveVehicleType.html#/c:@E@ZendriveVehicleType@ZendriveVehicleTypeUnknown) is passed, the default vehicleType will be used.
 *
 */
...
/**
 * Set the [driving behaviour score](https://zendrive-root.bitbucket.io/ios/docs/sdk-9.1.0-a1/Classes/ZendriveDriveScore.html) for this trip.
 * Default value of score is -1.
 */
- (ZendriveMockDriveBuilder *)setScore:(ZendriveDriveScore *)driveScore;

/**
 * Set the [event ratings](https://zendrive-root.bitbucket.io/ios/docs/sdk-9.1.0-a1/Classes/ZendriveEventRatings.html) for this trip.
 */
- (ZendriveMockDriveBuilder *)setEventRatings:(ZendriveEventRatings *)eventRatings;

/**
 * Set the [user mode](https://zendrive-root.bitbucket.io/ios/docs/sdk-9.1.0-a1/Enums/ZendriveUserMode.html).
 * Default value is [ZendriveUserModeDriver](https://zendrive-root.bitbucket.io/ios/docs/sdk-9.1.0-a1/Enums/ZendriveUserMode.html#/c:@E@ZendriveUserMode@ZendriveUserModeDriver).
 */
 ...
 *  - vehicleId passed to `-setVehicleTaggingDetails:` is invalid. Either it contains disallowed characters or it is longer than 64 characters.
 *  - `ZendriveMockDrive.vehicleType` is **not** set to [ZendriveVehicleTypeUnknown](https://zendrive-root.bitbucke.io/ios/docs/sdk-9.1.0-a1/Enums/ZendriveVehicleType.html#/c:@E@ZendriveVehicleType@ZendriveVehicleTypeUnknown) for a trip with `ZendriveMockDrive.driveType`
 *  as [ZendriveDriveTypeNonDriving](https://zendrive-root.bitbucket.io/ios/docs/sdk-9.1.0-a1/Enums/ZendriveDriveType.html#/c:@E@ZendriveDriveType@ZendriveDriveTypeNonDriving) or [ZendriveDriveTypeInvalid](https://zendrive-root.bitbucket.io/ios/docs/sdk-9.1.0-a1/Enums/ZendriveDriveType.html#/c:@E@ZendriveDriveType@ZendriveDriveTypeInvalid).
 *
 */
