...
/**
 * An event builder for [hard turn](https://zendrive-root.bitbucket.io/ios/docs/sdk-9.1.0-a1/Enums/ZendriveEventType.html#/c:@E@ZendriveEventType@ZendriveEventHardTurn) event.
 */
 ...
 * @param turnDirection [turn direction](https://zendrive-root.bitbucket.io/ios/docs/sdk-9.1.0-a1/Classes/ZendriveEvent.html#/c:objc(cs)ZendriveEvent(py)turnDirection) of the event.
 */
