...
/**
 * Set [event severity](https://zendrive-root.bitbucket.io/ios/docs/sdk-9.1.0-a1/Enums/ZendriveEventSeverity.html)
 */
- (ZendriveMockEventBuilder *)setSeverity:(ZendriveEventSeverity)severity;

/**
 * Build the mock event builder and return a [ZendriveEvent](https://zendrive-root.bitbucket.io/ios/docs/sdk-9.1.0-a1/Classes/ZendriveEvent.html).
 */
