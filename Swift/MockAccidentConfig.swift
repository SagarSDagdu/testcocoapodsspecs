...
@objc(ZDMockAccidentConfig) public class MockAccidentConfig: NSObject, NSCopying {
    ...
    ///
    /// [vehicleTypeId]: ../Enums/VehicleType.html
    /// [potentialId]: ../Protocols/ZendriveDelegate.html#/c:@M@ZendriveSDKSwift@objc(pl)ZendriveDelegate(im)processPotentialAccidentDetected:
    /// [finalId]: ../Protocols/ZendriveDelegate.html#/c:@M@ZendriveSDKSwift@objc(pl)ZendriveDelegate(im)processAccidentDetected:
    ...
    init(with config: ZendriveSDK.ZendriveMockAccidentConfig) {
        ...
        self.vehicleType = VehicleType.fromObjcVehicleType(config.vehicleType)
        self.collisionSeverity = CollisionSeverity.fromObjcCollisionSeverity(config.collisionSeverity)
        self.directionOfImpact = DirectionOfImpact.fromObjcDirectionOfImpact(config.directionOfImpact)
    }
    ...
    func asObjcZendriveMockConfig() -> ZendriveSDK.ZendriveMockAccidentConfig {
        ...
        config.vehicleType = self.vehicleType.toObjcVehicleType()
        config.collisionSeverity = self.collisionSeverity.toObjcCollisionSeverity()
        config.directionOfImpact = self.directionOfImpact.toObjcDirectionOfImpact()
        return config
    }
