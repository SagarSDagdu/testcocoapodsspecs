...
@objc(ZDLocationPoint) public class LocationPoint: NSObject {
    ...
    static func fromObjcLocationPoint(_ objcLocationPoint: ZendriveSDK.ZendriveLocationPoint) -> LocationPoint {
    ...
    static func convertArray(objcLocationPoints: [ZendriveSDK.ZendriveLocationPoint]?) -> [LocationPoint] {
    ...
    static func convertArray(swiftLocationPoints: [LocationPoint]?) -> [ZendriveLocationPoint] {
