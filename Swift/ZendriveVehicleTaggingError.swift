...
@objc(ZDZendriveVehicleTaggingError) public enum ZendriveVehicleTaggingError: Int {
    ...
    /// `ZendriveVehicleTagging.getNearbyBeacons(uuid:major:minor:completionHandler:)` failed to scan for beacons.
...
extension ZendriveVehicleTaggingError: LocalizedError {
    public var errorDescription: String? {
        ...
        case .beaconScanTimeout:
            return "The beacon scan has timed out."
        @unknown default:
